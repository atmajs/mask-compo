...
(function (root, factory) {
	...
	var Anchor = (function(){
		...
		return {
			...
			resolveCompo: function(element, findID /*?*/){
				if (element == null){
					return null;
				}
				do {
					...
					if (id != null){
						var compo = _cache[id];
						if (compo == null){
							compo = this.resolveCompo(element.parentNode, findID == null ? id : findID);
							if (compo != null){
								compo = Compo.find(compo, {
									key: 'ID',
									selector: findID == null ? id : findID,
									nextKey: 'components'
								});
							}
						}
